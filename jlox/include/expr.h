...
#define STMT_TYPES \
	...
	TYPE(Class, 3, Token, name, Expr::Variable*, superclass, std::vector<Stmt::Function>, methods) \
...
class Expr::Assign: public Expr { public: Assign(Token name, Expr* value): name(name), value(value) {} object_t accept(Visitor* visitor) override { return visitor->visitAssignExpr(*this); } Token name; Expr* value; }; class Expr::Binary: public Expr { public: Binary(Expr* left, Token op, Expr* right): left(left), op(op), right(right) {} object_t accept(Visitor* visitor) override { return visitor->visitBinaryExpr(*this); } Expr* left; Token op; Expr* right; }; class Expr::Call: public Expr { public: Call(Expr* callee, Token paren, std::vector<Expr*> arguments): callee(callee), paren(paren), arguments(arguments) {} object_t accept(Visitor* visitor) override { return visitor->visitCallExpr(*this); } Expr* callee; Token paren; std::vector<Expr*> arguments; }; class Expr::Get: public Expr { public: Get(Expr* object, Token name): object(object), name(name) {} object_t accept(Visitor* visitor) override { return visitor->visitGetExpr(*this); } Expr* object; Token name; }; class Expr::Grouping: public Expr { public: Grouping(Expr* expression): expression(expression) {} object_t accept(Visitor* visitor) override { return visitor->visitGroupingExpr(*this); } Expr* expression; }; class Expr::Literal: public Expr { public: Literal(object_t value): value(value) {} object_t accept(Visitor* visitor) override { return visitor->visitLiteralExpr(*this); } object_t value; }; class Expr::Logical: public Expr { public: Logical(Expr* left, Token op, Expr* right): left(left), op(op), right(right) {} object_t accept(Visitor* visitor) override { return visitor->visitLogicalExpr(*this); } Expr* left; Token op; Expr* right; }; class Expr::Set: public Expr { public: Set(Expr* object, Token name, Expr* value): object(object), name(name), value(value) {} object_t accept(Visitor* visitor) override { return visitor->visitSetExpr(*this); } Expr* object; Token name; Expr* value; }; class Expr::Super: public Expr { public: Super(Token keyword, Token method): keyword(keyword), method(method) {} object_t accept(Visitor* visitor) override { return visitor->visitSuperExpr(*this); } Token keyword; Token method; }; class Expr::This: public Expr { public: This(Token keyword): keyword(keyword) {} object_t accept(Visitor* visitor) override { return visitor->visitThisExpr(*this); } Token keyword; }; class Expr::Unary: public Expr { public: Unary(Token op, Expr* right): op(op), right(right) {} object_t accept(Visitor* visitor) override { return visitor->visitUnaryExpr(*this); } Token op; Expr* right; }; class Expr::Variable: public Expr { public: Variable(Token name): name(name) {} object_t accept(Visitor* visitor) override { return visitor->visitVariableExpr(*this); } Token name; };
